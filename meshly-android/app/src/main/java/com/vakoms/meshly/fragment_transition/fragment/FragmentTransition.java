...
import com.vakoms.meshly.fragment_transition.core.MoveData;
import com.vakoms.meshly.fragment_transition.core.TransitionAnimation;
...
public class FragmentTransition {
    ...
    public ExitFragmentTransition start(Bundle savedInstanceState) {
        ...
        final MoveData moveData = TransitionAnimation.startAnimation( toView, bundle, savedInstanceState, duration, interpolator);
        if (fragment == null) {
